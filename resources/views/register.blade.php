...
@section('content')
    <div class="col pt-4">
        ...
        <hr />
        <div class="content-background p-4 mb-5 row">
            <form method="POST" action="{{ route('createEvent') }}">
                ...
                <div class="form-group mb-4 row">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <input name="unidad-animal" step="0.01" type="number" class="form-control" id="unidad-animal" required>
                    </div>
                    <div class="col-12 col-lg-4">
                        <label for="tipo-animal">Evento</label>
                        <select name="evento" id="evento" class="form-select" aria-label="Seleccionar evento" required>
                            <option value="0" selected>Adquisición</option>
                            <option value="1" >Nacimiento</option>
                            <option value="2">Muerte</option>
                            <option value="3">Descarte</option>
                            <option value="4">venta para cría</option>
                            <option value="5">venta para beneficio</option>
                        </select>
                    </div>
                    <div class="col-12 col-lg-4">
                        <label for="cantidad">Cantidad</label>
                        <input name="cantidad" min="1" type="number" class="form-control" id="cantidad" required>
                    </div>
                </div>
